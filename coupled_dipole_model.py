...
class CalculateCrossSections:
    ...
    def plot_fromfile(self, drive):
        ...
        ygaplen = int(round((self.centers[1,1] - self.centers[0,1] - yrad1 - yrad2)*1E7))
...
def write_em_all():
    for zlength in range(90, 110, 10):
        for ygaplen in range(10, 50, 10):
            ylength=50
            zgaplen = 0
...
test.plot_twospectra(filename='check_with_simulation/simulated_spectra/two_ellipsoids/Spectrum_bemret_homo_50_100_y30_polz')
