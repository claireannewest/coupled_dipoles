...
epstab = { epsconst( 1.47^2 ), epstable( 'drude.dat' ) };
...
plot( 1240./enei, sca_mcsqrd, 'o-'  );  hold on;
xlabel( 'Energy (eV)' );
...
mie = miesolver( epstable( 'drude.dat' ), epsconst( 1.47^2 ), diameter, op, 'lmax', 1);
abs = mie.ext( enei ) - mie.sca( enei );
plot( 1240./enei, mie.sca( enei )*nmsqrd_to_micronsqrd);  hold on
